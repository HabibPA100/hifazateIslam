...
new #[Layout('layouts.guest')] class extends Component
{
    ...
    public function register(): void
    {
       ...
       // Handle image upload and rename it with the user's name
    if ($this->profile_image) {
        $imageName = time() . '.' . $this->profile_image->extension();
        $validated['profile_image'] = $this->profile_image->storeAs('profile_images', $imageName, 'public');
    }
...
<div>
    <form wire:submit="register">
        ...
        <div>
            ...
            <input type="file" wire:model="profile_image" class="block w-full p-2 mt-1 border rounded-md">
