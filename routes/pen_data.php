...
Route::get('/open/pen', function (GoogleSheetsService $googleSheetsService, Request $request) {
    $rows = $googleSheetsService->getRows('pen','PenData');
    ...
    return view('pen_data', ['posts' => $paginatedPosts]);
})->name('open.pen');
