<div>
    ...
    <!-- Posts List -->
    <div class="p-2">
        <h3 class="mb-4 text-2xl font-semibold text-gray-800">📜 Fatwa Post</h3>
        <div class="grid grid-cols-1 gap-4 p-1 lg:p-6 sm:grid-cols-2 lg:grid-cols-4">
            @if (!empty($posts))
                ...
                @endforeach
            @else
                <p class="col-span-full text-center text-gray-600">No fatwa post found for you!.</p>
            @endif
        </div>
    </div>
</div>
