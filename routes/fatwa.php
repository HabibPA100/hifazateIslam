...
Route::get('/read/fatwa', function (GoogleSheetsService $googleSheetsService, Request $request) {
    $rows = $googleSheetsService->getRows('fatwa','FatwaData');
    ...
    usort($posts, function ($a, $b) {
        return strtotime($b[2] ?? '1970-01-01') - strtotime($a[2] ?? '1970-01-01');
    });
    ...
    return view('fatwa', ['posts' => $paginatedPosts]);
})->name('read.fatwa');
